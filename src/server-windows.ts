  ...
  const s = new McpServer(
    { name: "desktop-touch", version: SERVER_VERSION },
    {
      instructions: [
        ...
        "  aim_identity_changed → the window this act was aimed at has closed and its handle now belongs to a DIFFERENT process; nothing was done. This is a refusal, not a failure — the action would have reached a stranger. Re-call desktop_discover for the replacement window and take a fresh lease; do NOT retry with the same handle, and do NOT retry by coordinate;",
