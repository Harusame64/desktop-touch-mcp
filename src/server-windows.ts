  ...
  const s = new McpServer(
    { name: "desktop-touch", version: SERVER_VERSION },
    {
      instructions: [
        ...
        "  value_not_applied → a type or setValue went through the native UI Automation client, the control said yes, and its value read back unchanged right after the write; nothing else was tried. Do not retry it or type into the same control another way (on a WinForms NumericUpDown a keystroke landed at its caret); re-call desktop_discover and check the field before writing again;",
