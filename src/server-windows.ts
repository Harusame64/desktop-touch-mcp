  ...
  const s = new McpServer(
    { name: "desktop-touch", version: SERVER_VERSION },
    {
      instructions: [
        ...
        "6. screenshot(detail='image') — visual inspection saved to disk",
        "",
        ...
        "- scroll(action='capture') → full-page stitched image saved to disk (use read tool to view)",
        "",
        "## Scroll capture",
        "scroll(action='capture') stitches full-page images saved to disk (pixel coords match screen for full-res captures). overlapMode='mixed-with-failures' means some frame seams have duplicate rows.",
        "",
