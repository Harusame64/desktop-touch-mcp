  ...
  const s = new McpServer(
    { name: "desktop-touch", version: SERVER_VERSION },
    {
      instructions: [
        ...
        "  aimed_uia_click_failed → the UIA route failed on the window this act named by handle, and the act was NOT finished as a coordinate click; nothing was clicked. Re-call desktop_discover, or try click_element(name=…) which re-resolves the element. Do NOT press the entity's rect — a coordinate is aimed at no window;",
