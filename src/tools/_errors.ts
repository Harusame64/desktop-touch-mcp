...
const SUGGESTS: Record<string, string[]> = {
  ...
  KeyboardTargetUnsafe: [
    ...
    "other_control / other_window: click the field you named first (desktop_act action='click' on the same entity), then type again — the background write goes to whatever holds the focus.",
