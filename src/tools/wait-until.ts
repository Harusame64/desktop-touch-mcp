 ...
 * answers normally, and before this the only trace was a line on the server's stderr. Since internal #144 a native TIMEOUT whose target does not answer WM_NULL does not fall back: `read_unfinished`, `via: "none"`.
 */
