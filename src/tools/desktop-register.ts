...
export function registerDesktopTools(server: McpServer): void {
  ...
  server.tool(
    ...
    [
      ...
      "  unknown → the handler threw before any road named a cause; it is NOT a refusal this tool decided, so the act may have taken effect. Observe again before acting, do not repeat the call as a retry, and read if_unexpected.try_next for the instrument;",
