...
export const terminalSendSchema = {
  ...
  preferClipboard: coercedBoolean().default(true).describe("Paste the input from the clipboard instead of typing it — safe for long text and not run through IME conversion (does not help while an IME composition is already in progress: the paste keystroke is consumed by the IME). The clipboard is restored afterwards; hints.clipboard reports whether it was. Default true."),
