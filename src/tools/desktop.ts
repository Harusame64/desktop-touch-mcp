...
import type { WindowBlockAnswer, TouchAction, TouchInput, TouchResult, ViewportVerdict } from "../engine/world-graph/guarded-touch.js";
...
export interface DesktopFacadeOptions {
   ...
   * recorded one, so the caller can reach it by `desktop_discover target.hwnd` (internal #126). Issue #63. When overridden alone (without
