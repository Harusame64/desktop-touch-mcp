  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "confirmImage": {
          "description": "Embed inline image pixels in the response. detail='image' now returns a cheap by-ref resource_link WITHOUT this flag (it is no longer blocked); confirmImage=true ADDITIONALLY embeds the inline image for immediate vision. detail='som' still requires confirmImage=true to return its annotated bitmap. Prefer detail='text' / diffMode=true / dotByDot=true first — set confirmImage=true only when inline visual inspection is genuinely required.",
          "type": "boolean",
          "default": false
        },
        "ocrFallback": {
