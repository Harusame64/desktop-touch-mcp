...
- **Evolving release to release** — discover-then-act targeting, browser semantic targeting, Key Locker, and multi-monitor capture keep gaining capability; each release notes what changed for you
...
- [v1.16.0 release notes](https://github.com/Harusame64/desktop-touch-mcp/releases/tag/v1.16.0)
...
- [v1.15.0 release notes](https://github.com/Harusame64/desktop-touch-mcp/releases/tag/v1.15.0)
...
- [v1.14.0 release notes](https://github.com/Harusame64/desktop-touch-mcp/releases/tag/v1.14.0)
...
- [v1.13.0 release notes](https://github.com/Harusame64/desktop-touch-mcp/releases/tag/v1.13.0)
