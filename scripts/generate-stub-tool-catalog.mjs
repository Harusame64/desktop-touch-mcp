...
// Phase 3: 50 - 4 (browser_launch / browser_get_dom / browser_get_app_state / browser_disconnect) = 46.
if (tools.length < 46) {
  throw new Error(`Expected at least 46 tools, generated ${tools.length}`);
}
