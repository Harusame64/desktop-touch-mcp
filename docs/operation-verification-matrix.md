...
| `input_exceeds_paste_warning_threshold` | `method:'foreground_flash'` の input pre-flight (改行 含 or UTF-16 >= 5KiB) で reject | ADR-013 §3.3.1 構造的回避、WT `largePasteWarning`/`multiLinePasteWarning` を trigger させない |
