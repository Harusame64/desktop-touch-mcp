...
作成: 2026-04-22  
更新: 2026-04-23 (P4-E Batch C / Tier 2 complete)  
...
**P4-E Batch C 更新（2026-04-23）:**

- Tier 1（技術的暫定 Go）に加え、Tier 2 dogfood 5 シナリオを完了
- G3（dogfood 実録）を ✅ close
- v0.17.0 default-on release candidate として進行可能
- 残る論点は blocker ではなく post-Go hardening（lease TTL / visual lane trigger / native common dialog）
...
| S5. Dogfood 実録 | ✅ 完了（2026-04-23） | 5 シナリオ実録 + 合格ライン 5 点チェック（G3） |
| S6. Default-on 最終判断 | ✅ Go（2026-04-23） | 詳細: [v17-final-decision-memo.md](anti-fukuwarai-v2-v17-final-decision-memo.md) |
...
| G3. Dogfood 実録 | **必須** | ✅ 閉 | 5 シナリオの実録ログ（合格ライン 5 点達成）— [`anti-fukuwarai-v2-dogfood-log.md`](anti-fukuwarai-v2-dogfood-log.md) |
...
G1・G2・G3・G4 は解消済み。G5 は deferred。default-on を止める blocker は解消済み。
...
| **Batch C** | Tier 1 技術的暫定 Go 確認・dogfood 手順書整備 / Tier 2 ユーザー実録（5 シナリオ）・最終判断 | ✅ 完了（2026-04-23） |

**default-on 再判定ライン:**
- Tier 1（技術的暫定 Go）: T1-T7 全 ✅ → **達成済み（2026-04-23）**
- Tier 2（dogfood 最終 Go）: 合格ライン 5 点満たす → **達成済み（2026-04-23）**
- 次アクション: `docs/release-process.md` に従って v0.17.0 release 実行へ進む
