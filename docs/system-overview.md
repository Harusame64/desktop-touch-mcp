...
```json
{
  ...
  "post": {
    ...
    "focusedElement": { "name": "Text editor", "type": "Document", "hasValue": true },
    "windowChanged": false,
    "elapsedMs": 42,
    "rich": {
      "diffSource": "uia",
