...
| # | Action | desc/examples | SUGGESTS | classify | matrix row | 判定 |
|---|---|---|---|---|---|---|
| 23 | browser_click | gap | pass | pass | **pass** (matrix narrowed 2 値 PR #221) | fix carry-over (doc gap) — G7 (G13 matrix narrow Resolved PR #221) |
...
| 26 | browser_fill | partial | pass | pass | **pass** (family inheritance synced PR #221) | fix carry-over (doc gap) — G9 (G13 family inheritance note Resolved PR #221) |
