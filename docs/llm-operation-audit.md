...
合計 **commit 軸 28 actions / 17 unique tool** (`terminal` 3 actions、`keyboard` 4 actions、`scroll` 5 actions など action 別展開で 28 行)。matrix doc §3.1 line 137-164 と bit-equal。
