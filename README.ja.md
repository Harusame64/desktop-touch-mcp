...
> *For the LLM agent community: this server applies MPEG P-frame diffing to window capture — only changed windows are sent after the first frame, cutting token usage by ~60-80% in typical automation loops.*
